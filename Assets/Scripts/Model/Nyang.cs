...
public class Nyang : MonoBehaviour
{
    ...
    // 냥이 한글 이름.
    public string NyangName;
    [SerializeField] private int nyangNameIndex;
    ...
    [Header("냥이 이미지: 방명록")] public Sprite visitSprite;
    ...
    [Header("냥이 조건")] [TextArea] public string condition;
    ...
    [SerializeField] private int personalityIndex;
    ...
    [SerializeField] private int story1Index;

    public int Story1Index => story1Index;

    [SerializeField] private int story2Index;

    public int Story2Index => story2Index;

    [SerializeField] private Sprite sprStory1;

    public Sprite SprStory1 => sprStory1;

    [SerializeField] private Sprite sprStory2;

    public Sprite SprStory2 => sprStory2;
    ...
    [SerializeField] private Slider sliderWait;
